...
export const HEART_FAILURE_SCHEMA: RiskSchema = {
  ...
  fields: [
    ...
    { key: "FastingBS", label: "Fasting Blood Sugar (0 = <126 mg/dL, 1 = ≥126 mg/dL)", type: "number" },
    {
      key: "RestingECG",
      label: "Resting ECG",
      type: "select",
...
export const DIABETES_SCHEMA: RiskSchema = {
  ...
  fields: [
    ...
    { key: "HighChol", label: "High Cholesterol (0 = No, 1 = Yes)", type: "number" },
    { key: "CholCheck", label: "Cholesterol Check in Last 5 Years (0/1)", type: "number" },
    ...
    { key: "HeartDiseaseorAttack", label: "History of CHD or MI (0 = No, 1 = Yes)", type: "number" },
    { key: "PhysActivity", label: "Any Physical Activity in Last 30 Days (0/1)", type: "number" },
    { key: "Fruits", label: "Fruit Consumption ≥1/day (0/1)", type: "number" },
    { key: "Veggies", label: "Vegetable Consumption ≥1/day (0/1)", type: "number" },
    { key: "HvyAlcoholConsump", label: "Heavy Alcohol Consumption (0/1)", type: "number" },
    { key: "AnyHealthcare", label: "Any Healthcare Coverage (0/1)", type: "number" },
    { key: "NoDocbcCost", label: "Could Not See Doctor Because of Cost (0/1)", type: "number" },
    { key: "GenHlth", label: "General Health (1 = Excellent … 5 = Poor)", type: "number" },
    { key: "MentHlth", label: "Mental Health — Days Not Good (0–30)", type: "number" },
    { key: "PhysHlth", label: "Physical Health — Days Not Good (0–30)", type: "number" },
    { key: "DiffWalk", label: "Difficulty Walking or Climbing Stairs (0/1)", type: "number" },
    { key: "Sex", label: "Sex (0 = Female, 1 = Male)", type: "number" },
    { key: "Age", label: "Age Category (1–13)", type: "number" },
    { key: "Education", label: "Education Level (1–6)", type: "number" },
    { key: "Income", label: "Income Level (1–8)", type: "number" },
  ],
};
...
export const STROKE_SCHEMA: RiskSchema = {
  ...
  fields: [
    ...
    { key: "Residence_type", label: "Residence (0 = Rural, 1 = Urban)", type: "number" },
